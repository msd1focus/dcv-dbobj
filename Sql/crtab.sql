...
--   at:        2019-03-15 08:42:58 ICT
--   site:      Oracle Database 11g
--   type:      Oracle Database 11g



DROP TABLE file_pendukung CASCADE CONSTRAINTS;

DROP TABLE holiday CASCADE CONSTRAINTS;

DROP TABLE message CASCADE CONSTRAINTS;

DROP TABLE req_line_breakdown CASCADE CONSTRAINTS;

DROP TABLE request_dtl CASCADE CONSTRAINTS;

DROP TABLE request_hdr CASCADE CONSTRAINTS;
...
COMMENT ON COLUMN request_hdr.ppn IS
...
CREATE TABLE role (
    id          INTEGER NOT NULL,
    role_code   VARCHAR2(15 CHAR),
    role_desc   VARCHAR2(50 CHAR),
    sla1        INTEGER,
    sla2        INTEGER
);

COMMENT ON COLUMN role.sla1 IS
    'sla1 : target berapa hari proses harus selesai diproses';

COMMENT ON COLUMN role.sla2 IS
    'cadangan';
...
COMMENT ON COLUMN "User".rank IS
    'Superviser, member';

COMMENT ON COLUMN "User".sp_assign1 IS
    'mis: 
